       ...
       if(HitCheck)
        {
            if (other.gameObject.tag == "Player")
            {
                ...
                {
                    case LoadType.Up: 
                        player.SetType(player.playerType.Up); break;
                    case LoadType.Right:
                        player.SetType(player.playerType.Right); break;
                    case LoadType.Down: 
                        player.SetType(player.playerType.Down); break;
                    case LoadType.Left: 
                        player.SetType(player.playerType.Left); break;
                    default: break;
                }
